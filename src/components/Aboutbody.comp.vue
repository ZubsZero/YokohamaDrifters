...
<div class="cards">
    ...
    <div class="Zubair">
        <div class="card-img">
            <img src="https://i.postimg.cc/tJP06qpN/C12-Zubair-Matthee.jpg" alt="Zubair" class="image">
        </div>
        <div class="card-info">
    ...
    <div class="div">
        <h2 class="h2">CEO</h2><br>
      
        <hr>
        <br>
          <p class="text">The Founders of YokoHama Drifters</p>
    </div>    
    <div class="Marcel">
        <div class="card-img">
<img src="https://i.postimg.cc/rwrMMByT/c12-marcel-brown-1.jpg" alt="Marcel" class="image">
        </div>
        <div class="card-info">
            <h2>Marcel Brown</h2>
            <h3>Co-CEO</h3>
